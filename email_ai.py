                    ...
                    "messages": [
                        {
                            "role": "system",
                            "content": (
                                f"You are an {self.language} email assistant. Reply in {self.language}. "
                                ...
                                f"If unsure, use type=other. Keep content as one concise short {self.language} sentence of the main point. "
